...
let faultLines = "https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json";
let M45Earthquakes = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson";
...
// 3. Retrieve the major earthquake GeoJSON data >4.5 mag for the week.
  d3.json(M45Earthquakes).then(function(data) {
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  d3.json(faultLines).then(function(data) {
    console.log(data);
    L.geoJson(data, {
      style: tectStyle,
      onEachFeature: function(feature, latlng) {
        console.log(latlng);
        latlng.bindPopup("<h3>Plate Name: " + feature.properties.Name + "</h3>");
      }
    }).addTo(tectData);
    tectData.addTo(map);
  });
